...
import { demoKidsSentences } from '../constants/demo_kids_sentences';
...
class SpeakPage extends React.Component<Props, State> {
    ...
    static async getInitialProps(ctx: NextPageContext) {
        ...
        //     host,
        // });
        const demoSentences = demoKidsSentences;

        const initialSentences: AllGroupsSentences = {};
        initialSentences[AgeGroups.ADULTS] = demoKidsSentences;
        initialSentences[AgeGroups.TEENAGERS] = demoKidsSentences;
        initialSentences[AgeGroups.CHILDREN] = demoKidsSentences;
