    ...
    return (
        <WhyContainer>
            <WhyInformation>
                ...
                <WhyParagraph>
                    Þess vegna er mikilvægt að missa ekki af lestinni og nú er hafin vinna við stórt samstarfsverkefni til þess að gera íslensku gjaldgenga í tölvum og tækjum. Að því koma íslenskir háskólar, stofnanir, fyrirtæki og félagasamtök, sem munu á næstu árum þróa nauðsynlega innviði fyrir hugbúnað sem skilur og talar íslensku. Samrómur verður hluti af þessu verkefni, opið gagnasafn raddsýna fyrir íslensku sem hver sem getur notað til þess að þróa sínar máltæknilausnir. Með þessu tryggjum við öryggi íslenskunnar á stafrænum tímum.
                </WhyParagraph>
                <WhyParagraph>
                    Lesa má meira um máltækni áætlun íslands <StyledLink target={'blank'} href={'https://www.stjornarradid.is/lisalib/getfile.aspx?itemid=56f6368e-54f0-11e7-941a-005056bc530c'}>hér</StyledLink>.
                </WhyParagraph>
            </WhyInformation>
