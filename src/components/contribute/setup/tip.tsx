...
export const Tip: React.FC<Props> = ({ children, className, icon, ref, title }) => {
...
export default React.forwardRef((props: Props, ref: React.Ref<HTMLDivElement>) => <Tip {...props} ref={ref as any} />);