...
export const TipsVerify: React.FC<Props> = () => (
    ...
    <div>
        <Tip
            ...
            title={"Meginreglan"}>
            <p>
            Meginreglan er að það sem heyrist í upptökunni verður að stemma við það sem stendur í textanum. Heyra dæmi um góða upptöku „Þú þarft að fara út að leita“:
            </p>
        ...
        <Tip
            ...
            title={"Brothljóð"}>
            <p>
                Það getur komið fyrir að upptaka takist ekki fullkomlega og það kemur hljóð sem má kalla brothljóð. Slíkar upptökur 
                á að merkja sem slæmar. Heyra dæmi um góða upptöku „Allir verkir eru í burt“:
            </p>
